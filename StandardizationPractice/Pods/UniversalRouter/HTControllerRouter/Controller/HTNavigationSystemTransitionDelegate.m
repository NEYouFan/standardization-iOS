...
@interface HTNavigationSystemTransitionDelegate()<UIGestureRecognizerDelegate, HTNavigationGestureHandlerDelegate>
...
@implementation HTNavigationSystemTransitionDelegate
...
- (instancetype)initWithParentViewController:(UINavigationController*)navigationController
{
    ...
    if (self){
        ...
        _popInteractiveTransitionClass = nil;
        _pushTransitionClass = nil;
        _interactiveTransitionClass = nil;
        
        _gestureHandler = [[HTNavigationSystemPanGestureHandler alloc] initWithNavigationController:navigationController gestureHandlerDelegate:self];
    }
