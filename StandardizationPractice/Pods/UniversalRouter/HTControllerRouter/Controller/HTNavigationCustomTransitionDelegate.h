 ...
 */
@interface HTNavigationCustomTransitionDelegate : NSObject<UINavigationControllerDelegate, HTNavigationDelegateInitProtocol>
...
/**
 *  设置交互pop Transition
 *  default HTNavigationTransitionAnimator
 *  可选值：实现协议UIViewControllerAnimatedTransitioning的类
 */
...
/**
 *  支持设置交互动画
 *  default HTPercentDrivenInteractiveTransition
 *  可选值：UIPercentDrivenInteractiveTransition及其子类
 */
 ...
 *  default nil
 *  可选值：HTPercentDrivenInteractiveTransition,模仿系统的手势后退效果;UIPercentDrivenInteractiveTransition及其子类
 */
