...
NSString * const SPDatabaseName = @"SPCache.db";

@interface SPDataBaseHelper ()
...
@implementation SPDataBaseHelper

#pragma mark - Life Cycle

+ (instancetype)sharedInstance {
    static SPDataBaseHelper *_sharedInstance = nil;
...
+ (NSArray *)setupSqls {
    return @[
             @"CREATE TABLE TBL_SP_CACHE_PROFILE (location TEXT)",
             @"INSERT INTO TBL_SP_CACHE_PROFILE (location) VALUES ('西山森林公园     杭州')",
             @"INSERT INTO TBL_SP_CACHE_PROFILE (location) VALUES ('云栖竹径     杭州')",
             ];
}
