...
#import "SPMineCollectionController.h"
...
@interface SPMineCollectionController () <HTRouteTargetProtocol,
                                          HTContainerViewControllerProtocol,
                                          HTNavigationBackPanGestureProtocol>

@end

@implementation SPMineCollectionController
...
+ (NSString*)urlPath {
    return @"standardization://mine/collection";
}
