...
#import "SPMinePreferenceController.h"
...
@interface SPMinePreferenceController () <HTRouteTargetProtocol,
...
@implementation SPMinePreferenceController
...
+ (NSString*)urlPath {
    return @"standardization://mine/preference";
}
